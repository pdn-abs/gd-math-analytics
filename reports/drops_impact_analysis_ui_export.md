...
| Avg Session Duration | Average time users spend in engaged sessions. | 118 (minutes) | 147 (minutes) | 24.8 | Measures session depth and user immersion in the app. | Longer durations indicate deeper engagement. The 25% increase from ~118 min to ~147 min shows users spending significantly more time per session post-drops. | Optimize session flow, add compelling content progression, reduce friction points. |
